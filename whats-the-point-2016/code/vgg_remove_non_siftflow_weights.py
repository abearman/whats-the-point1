...
for pr, pr_conv in zip(params, params_full_conv):
	# We do copy the last layer, but only the correct 33 indices
	if pr == 'fc8':
...
net_full_conv.save('/imagenetdb3/abearman/caffe/models/vgg16-conv-siftflow/vgg16-conv-siftflow.caffemodel')
